...
import com.comp232.todo1.AddToArrayListService.AddBinder;

public class MainActivity extends AppCompatActivity {

        // declare
        ListView myListView;
        EditText myEditText, editTextDate;
...
//        final ArrayAdapter<String> arrayAdapter;
        arrayAdapter = new ArrayAdapter<Task>(this, android.R.layout.simple_list_item_1, addToArrayListService.getToDoItems());
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    if(event.getAction() == KeyEvent.ACTION_DOWN)
                        if(keyCode == KeyEvent.KEYCODE_ENTER) {
                            ...
                            addToArrayListService.addToList(myEditText.getText().toString(), editTextDate.getText().toString());
                            // update UI
                            arrayAdapter.clear();
                            arrayAdapter.addAll(addToArrayListService.getToDoItems());
